...
public class WorkerRosteringApp {
    ...
    public static void main(String[] args) {
        ...
        SolverFactory<Roster> solverFactory = SolverFactory
				.createFromXmlResource("solver/rosteringSolverConfig.xml");
		Solver<Roster> solver = solverFactory.buildSolver();

		// Solve the problem
		Roster solverPlan = solver.solve(roster);
        ...
        solutionFileIO.write(solverPlan, outputSolutionFile);
